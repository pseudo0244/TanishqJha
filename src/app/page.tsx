  ...
  return (
    <main>
      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-6 py-20 max-w-7xl mx-auto !bg-white">
        ...
        <div className="w-full md:w-1/2 mt-16 md:mt-0 relative flex justify-end items-center">
          {/* Background image */}
          <img
            src="/home/hero1.png"
            alt="Background"
            className="absolute right-0 w-[340px] md:w-[400px] rounded-lg shadow-lg z-0"
          />
          {/* Overlay image */}
          <img
            src="/home/hero2.png"
            alt="Foreground"
            className="absolute top-0 right-0 translate-y-[-90px] translate-x-[-20px] w-[300px] md:w-[340px] rounded-lg shadow-xl z-10"
          />
        </div>
      </section>
  ...
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start gap-16">
    ...
    <div className="w-full md:w-[50%] text-[#3b2f30]">
      <h2 className="text-[64px] md:text-[50px] font-bold leading-snug font-afacad uppercase tracking-tight">
        STILL WAITING FOR THE RIGHT<br />
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-start px-4 md:px-0 font-serif">
      ...
      <div className="flex flex-col justify-left relative">
        <h2 className="text-2xl md:text-4xl font-light uppercase leading-snug text-left">
          YOUR TIME AND ENERGY ARE MY TOP PRIORITIES
        </h2>
        <p className="mt-6 text-xl md:text-2xl uppercase">SO YOU CAN…</p>

        <div className="relative mt-10">
          <p className="text-2xl md:text-3xl font-light z-10 relative leading-tight">
            FOCUS ON GROWTH, NOT THE GRIND, AND BUILD YOUR FREEDOM-FOCUSED
            BUSINESS
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-start mt-28">
          ...
          <div>
            ...
            <div className="space-y-6 text-lg md:text-xl font-medium leading-relaxed">
              ...
              <p>Imagine The Mental Space You'll Gain When You're No Longer Juggling A Million Tasks At Once.</p>
            </div>
          </div>

          {/* Right Column - Laptop Image with Quote */}
          <div className="relative">
            <img src="/home/hero5.png" alt="Desk with notes and coffee" className="w-full max-w-sm rounded shadow-lg" />
            <span className="text-[120px] text-gray-300 absolute bottom-0 right-0 leading-none select-none z-0">"</span>
          </div>
        </div>
      </section>
      ...
      <section className="font-['Didot',serif] border-t border-black bg-white py-12 px-6 md:px-20">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-10">
          ...
          <div className="md:w-1/2 flex justify-center md:justify-start">
            <img src="/home/tanishq.png" alt="Support Person" className="border-4 border-[#2E63C2] max-w-[400px]" />
          </div>
          ...
          <div className="md:w-1/2 bg-[#EBD3C1] p-8 rounded-md">
            ...
            <h3 className="text-[20px] text-[#fff] font-semibold tracking-wide mb-4 uppercase">INSTEAD...</h3>
            <p className="italic text-[17px] text-[#2E2E2E] mb-4 leading-relaxed">
              You now have someone who's uniquely positioned as your trusted support system, ensuring you make the most
      ...
      <section className="bg-white px-6 py-12 md:px-20 font-['Didot',serif] border-t border-black">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-10">
          ...
          <div className="relative w-full md:w-[300px] min-w-[260px] flex justify-center md:justify-start">
            ...
            <img src="/home/hero10.png" alt="Coffee Cup" className="w-[260px] h-[340px] object-cover relative left-4" />
          </div>
