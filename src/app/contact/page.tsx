...
interface FormData {
  ...
  revenueRange: string[]
  message?: string // Add the message field
}
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="relative w-full h-[300px] md:h-[400px]">
        <Image src="/contact.png" alt="Get In Touch" fill className="object-cover" priority />
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-3xl md:text-8xl font-light text-white drop-shadow-lg font-['afacad']">Get In Touch</h1>
        </div>
      </div>
      {/* Heading Section */}
