  ...
  return (
    <>
      ...
      <section className="w-full bg-white px-6 py-20 flex flex-col items-center text-black">
        <div className="max-w-6xl w-full flex flex-col md:flex-row items-center justify-center gap-16">
          ...
          <div className="w-full md:w-1/2 space-y-6 font-['Poppins']">
            <h2 className="text-3xl md:text-5xl font-light underline underline-offset-8 mb-4">What You Get:</h2>
      ...
      <section className="py-16 px-6">
        <h2 className="text-5xl font-medium tracking-wider mb-10 text-center font-['aboreto']">
      ...
      <section>
        ...
        >
          ...
          <p className="text-lg md:text-xl text-black mb-10 max-w-3xl mx-auto font-['poppins']">
            Prefer talking it out instead of reading through details? Let&apos;s connect, and I&apos;ll help you choose
            the best offer to suit your business needs.
          </p>
          <a
            href="#schedule-call"
