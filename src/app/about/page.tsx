    ...
    <div className="bg-white text-black">
      ...
      <section className="flex flex-col md:flex-row items-center justify-center px-4 md:px-20 py-20 gap-12 bg-white relative overflow-hidden">
        ...
        <div className="w-full md:w-2/3 max-w-xl text-left z-10">
          <h2 className="text-lg md:text-7xl font-normal mb-3 tracking-wide font-['afacad']">HI, I AM TANISHQ...</h2>

          <p className="text-xl md:text-2xl leading-relaxed tracking-wide font-light font-['afacad']">
          ...
          <p className="text-2xl mt-6 font-['poppins']">(Yes, you can have both)</p>
        </div>
      </section>
      ...
      <section className="px-6 md:px-20 py-16 bg-white">
        {/* Title */}
        <h2 className="text-2xl md:text-4xl font-light text-center mb-12 leading-relaxed font-['afacad']">
        ...
        <div className="bg-[#ecd7c8] rounded-none md:rounded-lg p-6 md:p-10 flex flex-col md:flex-row items-center gap-6 md:gap-12 max-w-6xl mx-auto">
          ...
          {/* Testimonial Text */}
          <div className="text-base md:text-2xl leading-relaxed text-black font-['poppins']">
            <p>
            Tanishq came on board to help me in creating my freebie, help me with the launch. She completely took the entire process and work off my shoulders and did it with such perfection.
            She is not only skilled but also very punctual, efficient in handling tasks. I would highly recommend her to anyone looking to onboard a VA.
            </p>
            <p className="font-semibold mt-4">Roshni, Copywriter & Business Strategist</p>
          </div>
        </div>
      </section>
      <section className="relative bg-white px-6 md:px-20 border-t-1 border-[#4A3733]"></section>
  ...
  <div className="mt-12 md:mt-16 max-w-6xl mx-auto">
    ...
    <div className="flex flex-col md:flex-row items-stretch gap-8 md:gap-12">
      ...
      <div className="w-full md:w-7/12 bg-white rounded-[30px] shadow-xl p-6 md:p-10 flex flex-col justify-center relative md:pr-0 md:rounded-r-none">
        ...
        <h3 className="text-4xl md:text-6xl text-[#5f4b46] mb-4 font-medium text-left pr-8 z-20 font-['afacad']">
          Here&apos;s how it works:
        </h3>

        {/* Inner content with padding to ensure text doesn't touch the edge */}
        <div className="pr-6 md:pr-10">
          <p className="text-[#5f4b46] text-sm md:text-base mb-5 leading-relaxed tracking-wide font-['poppins']">
          ...
          <p className="text-[#5f4b46] text-sm md:text-base leading-relaxed tracking-wide font-['poppins']">
...
<section className="flex flex-col md:flex-row items-start justify-between px-6 md:px-12 py-10 gap-8 bg-white max-w-7xl mx-auto">
  ...
  <div className="md:w-1/2 space-y-4">
    <h2 className="text-4xl font-bold text-amber-950 font-['afacad']">
      TANISHQJHA.CO STARTED WITH AN ASPIRATION FOR FREEDOM AND FULFILLMENT
    </h2>
    <p className="font-semibold text-gray-800 font-['poppins'] text-xl">
      Hi, I am Tanishq, founder of TanishqJha.co OBM and VA services
    </p>
    <p className="text-amber-950 font-['poppins'] text-xl">
    ...
    />
      ...
      <section className="flex flex-col md:flex-row items-center justify-center px-6 py-12 max-w-7xl mx-auto">
        ...
        <div className="w-full md:w-1/2 md:pl-10 pt-10 md:pt-0 text-[#3D2B2B]">
          <h2 className="`text-3xl md:text-6xl font-semibold mb-6 font-['afacad']">
          ...
          <p className="text-lg font-extrabold mt-6 font-['afacad'] text-black uppercase tracking-wide">
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <h3 className="text-2xl md:text-3xl font-light mb-6 font-['poppins']">(NOT EXHAUSTION AND OVERWHELM)</h3>
      ...
      <section className="w-full py-16 px-6 text-center">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-7xl font-light mb-2 font-['afacad']">I BELIEVE IN WALKING THE TALK</h2>
          <h3 className="text-xl md:text-4xl font-light mb-12 mt-7 font-['poppins']">THIS IS MY FOUNDATION…</h3>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              />
              <h4 className="text-3xl font-medium font-['afacad']">Freedom and Fulfillment</h4>
              <p className="text-md uppercase tracking-widest text-gray-600 mt-1 mb-4 font-['afacad']">
            ...
            <div>
              <Image
                ...
                className="mx-auto mb-6 w-60 h-auto object-cover"
              />
              <h4 className="text-3xl font-medium font-['afacad']">Empathy and Care</h4>
              <p className="text-md uppercase tracking-widest text-gray-600 mt-1 mb-4 font-['afacad']">
                YOUR WIN, MY WIN
              </p>
              <p className="text-base max-w-md mx-auto font-['poppins'] mt-5">
      ...
      <section className="w-full py-16 px-6 text-center">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-2 gap-12 mb-12">
          ...
          <div>
            <Image
              ...
              className="mx-auto mb-6 w-60 h-auto object-cover"
            />
            <h4 className="text-3xl font-medium font-['afacad']">Authenticity & Transparency</h4>
            <p className="text-md uppercase tracking-widest text-gray-600 mt-1 mb-4 font-['afacad']">
          ...
          <div>
            ...
            />
            <h4 className="text-3xl font-medium font-['afacad']">Honesty & Ethical Practices</h4>
            <p className="text-md uppercase tracking-widest text-gray-600 mt-1 mb-4 font-['afacad']">
        ...
        <div className="max-w-3xl mx-auto">
          <Image
            ...
            className="mx-auto mb-6 w-60 h-auto object-cover"
          />
          <h4 className="text-3xl font-medium font-['afacad']">Respect and Collaboration</h4>
          <p className="text-md uppercase tracking-widest text-gray-600 mt-1 mb-4 font-['afacad']">
      ...
      <section className="bg-[#483435] text-white px-6 py-16">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-10">
          ...
          <div className="text-center lg:text-left max-w-2xl">
            <h2 className="text-3xl sm:text-5xl font-light tracking-widest mb-7 font-['afacad']">
